...
import { Database, Truck, Package, Phone, PiIcon as ApiIcon } from "lucide-react";
...
export default function Services() {
  return (
    <section className="py-32 bg-gradient-to-br from-purple-50 via-pink-50 to-purple-50">
      {/* Use fullWidth so this section spans the viewport (with side padding) */}
      <Container fullWidth>
        ...
        {/* Removed the centered max-width so service cards can take more horizontal space */}
