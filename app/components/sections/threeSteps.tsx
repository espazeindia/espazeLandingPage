...
const StepCard = memo(({ step, isLeft }: { step: Step; isLeft: boolean }) => {
	const baseClasses = "w-full max-w-md rounded-xl bg-purple-50 p-6 text-sm shadow-sm";
...
export default function Steps() {
	return (
      ...
      <div className="flex flex-col md:flex-row items-start gap-12">
        ...
        <ScrollReveal direction="right" className="md:w-1/2 flex items-center justify-center">
