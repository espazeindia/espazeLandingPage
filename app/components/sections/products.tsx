...
export default function Products() {
    ...
    return (
        <section className="py-12 pb-32">
            {/* Use fullWidth container so this section expands horizontally */}
            <Container fullWidth>
                        ...
                        {PRODUCT_CARDS.map((card) => (
                            ...
                            >
                                <div
                                    ...
                                    className={`flex flex-col items-start rounded-xl bg-purple-50 p-6 shadow-lg transition-all duration-300 ${
                                        card.link 
                                            ? 'cursor-pointer hover:shadow-xl hover:bg-purple-100' 
                                            : ''
                                    }`}
                                >
                                    <div className="relative w-full h-48 bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg shadow-sm overflow-hidden">
