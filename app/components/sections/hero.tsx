      ...
      <div className="max-w-6xl mx-auto px-6 py-20 md:py-32 relative z-10">
        <div className="max-w-3xl bg-gray-900/80 p-8 rounded-3xl shadow shadow-sm">
          ...
          <div className="flex flex-wrap gap-4 mb-12 animate-slide-in-left" style={{ animationDelay: "0.2s" }}>
            <Button href="/seller" variant="gradient" size="lg" rounded="full" className="flex items-center gap-2">
              Start Selling Today
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Button>

            <Button href="/customer" variant="secondary" size="lg" rounded="full" className="flex items-center gap-2">
              Shop Now
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Button>
          </div>
