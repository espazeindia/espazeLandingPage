...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-start bg-black">
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-purple-50/70 via-pink-50/70 to-purple-100/70" />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-20 md:py-32 relative z-10">
        <div className="max-w-3xl">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 animate-slide-in-left">
            <span className="text-gray-900">Smart warehousing.</span>
            <br />
            <span className="bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent">Instant delivery.</span>
          </h1>

          {/* Description */}
          <p className="text-gray-700 text-lg md:text-xl mb-8 leading-relaxed max-w-2xl animate-slide-in-left" style={{ animationDelay: "0.1s" }}>
